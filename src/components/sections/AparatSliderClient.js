        ...
        >
          {aparatList.length === 0 ? (
            Array.from({ length: 4 }).map((_, idx) => (
              <div
                key={idx}
                className="flex-shrink-0 w-[290px] sm:w-[310px] bg-white rounded-2xl border border-slate-100 p-4 space-y-4 animate-pulse"
              >
                <div className="bg-slate-200 h-72 rounded-xl w-full" />
                <div className="space-y-2">
