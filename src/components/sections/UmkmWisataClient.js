...
/**
 * UmkmWisataClient — Client Component
 *
 * Menerima data UMKM dan Wisata dari Server Component parent sebagai props.
 * Handle tabs (Semua / UMKM / Wisata) secara client-side — instant, tanpa fetch ulang.
 */
...
export default function UmkmWisataClient({ umkmList, wisataList }) {
