...
// Data di-fetch langsung di server sebelum HTML dikirim ke browser.
...
import { getAparat, getKadesInfo, getRecentArticles } from "@/lib/queries";
...
export default async function Home() {
  // Semua query jalan paralel di server — tidak menunggu satu per satu
  const [kadesInfo, recentArticles, aparatList] = await Promise.all([
    getKadesInfo(),
    getRecentArticles(),
    getAparat(),
  ]);
  ...
  return (
    <div className="space-y-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                &ldquo;Selamat datang di portal informasi resmi Desa Tempursari.
                Website ini hadir sebagai wujud komitmen kami dalam memajukan
                desa di era digital, meningkatkan transparansi publik, dan
                mendekatkan pelayanan kepada masyarakat.&rdquo;
              </p>
              <p className="text-slate-600 text-sm leading-relaxed">
                Kami berkomitmen untuk terus melestarikan kesenian daerah,
                mempromosikan produk UMKM warga, dan mempermudah akses peta
                tata ruang desa demi kemudahan koordinasi pembangunan. Kami
                berharap portal ini bermanfaat bagi seluruh masyarakat dan
                publik yang ingin mengenal potensi Desa Tempursari.
              </p>
              <div className="pt-2">
                <Link
                  href="/profil/lembaga"
      ...
      {/* Data aparat sudah di-fetch di atas, dikirim sebagai prop */}
      <AparatSlider initialData={aparatList} />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12">
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-sm">
                Ikuti perkembangan berita pembangunan, pengumuman resmi, dan
                kegiatan sosial warga Tempursari.
              </p>
            </div>
            <Link
              href="/kabar-desa"
          ...
          {/* Grid Content — data langsung dari server, tidak ada skeleton */}
